...
export const POSITIONS: TaxonomyItem[] = [
  ...
  { id: 'ashi_garami', name: 'Ashi Garami', aliases: ['outside ashi', 'knee shield ashi'] },
  { id: 'inside_sankaku', name: 'Inside Sankaku', aliases: ['saddle', 'honey hole', 'inside heel hook position', '411'] },
  // ── Advanced / system-specific positions ─────────────────────────────────────
  { id: 'truck', name: 'Truck', aliases: ['crab ride'] },
  { id: 'crucifix', name: 'Crucifix', aliases: ['arm and leg crucifix'] },
  { id: 'rubber_guard', name: 'Rubber Guard', aliases: ['mission control', 'new york'] },
  { id: 'worm_guard', name: 'Worm Guard', aliases: ['lapel guard'] },
  { id: 'k_guard', name: 'K Guard', aliases: ['outside heel hook entry', 'sumi gaeshi position'] },
