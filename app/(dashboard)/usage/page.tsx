    ...
    <div className="max-w-2xl space-y-8">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <StatCard
            ...
            value={String(stats.matchesThisMonth)}
          />
          <StatCard
            label="Video analysed"
            value={fmtMinutes(stats.videoMinutesThisMonth)}
          />
          <StatCard
            label="Opponents scouted"
            value={String(stats.opponentsScoutedThisMonth)}
          />
          <StatCard
            label="Gameplans built"
            value={String(stats.gameplansThisMonth)}
          />
        </div>
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <StatCard
            label="Matches analysed"
            value={String(stats.matchesAllTime)}
          />
          <StatCard
            label="Video analysed"
            value={fmtMinutes(stats.videoMinutesAllTime)}
          />
          <StatCard
            label="Opponents scouted"
            value={String(stats.opponentsScoutedAllTime)}
          />
          <StatCard
            label="Gameplans built"
            value={String(stats.gameplansAllTime)}
          />
        </div>
      </div>
    </div>
