          ...
          {timelineItems.length === 0 ? (
            ...
            <div className="relative">
              <div className="flex flex-wrap items-center gap-x-4 gap-y-1.5 text-xs text-muted-foreground pb-3">
                ...
                <span className="flex items-center gap-1.5"><span className="w-2.5 h-2.5 rounded-full bg-blue-400 flex-shrink-0" />{competitorLabel ? `${competitorLabel}'s action` : 'Your action'}</span>
                <span className="flex items-center gap-1.5"><span className="w-2.5 h-2.5 rounded-full bg-orange-400 flex-shrink-0" />{opponentLabel ? `${opponentLabel}'s action` : 'Opponent action'}</span>
              </div>
