...
const FAQ_GROUPS = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Yes — RollPlan is in active beta. Core features work reliably but you may encounter rough edges, and AI analysis isn\'t perfect. If something goes wrong, the "Re-scan" button resets a failed video and the "Wrong result?" and "Wrong?" correction tools let you fix AI mistakes inline. Found a bug or have feedback? Email feedback@rollplan.ai — we read every message.',
      },
    ],
  },
  {
